...
alter table job_history
    ...
    add constraint fk_job_emp foreign key (employee_id)		references employees (employee_id),
    add constraint fk_job_dep foreign key (department_id) 	references departments (department_id),
    add constraint fk_job_job foreign key (job_id) 			references jobs (job_id);
...
alter table product_descriptions
    ...
    add constraint fk_pro_pro foreign key (product_id) references product_information (product_id);
...
alter table order_items
    add constraint pk_ord 	  primary key (order_id),
    add constraint fk_ord_pro foreign key (product_id) references product_information (product_id);
alter table order_items
    add constraint fk_ord_ord foreign key (order_id)   references orders (order_id);