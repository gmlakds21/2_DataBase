...
public class Samkwang_VO_CODP {
    ...
    public Samkwang_VO_CODP(int 고객번호, String 고객이름, int 주문번호, String 주문일, int 제품번호, int 수량, String 제품이름, int 단가) {
        this.고객번호 = 고객번호;
        this.고객이름 = 고객이름;
        this.주문번호 = 주문번호;
        this.주문일 = 주문일;
    ...
    public Samkwang_VO_CODP(int 제품번호, int 주문번호, int 고객번호, String 고객이름, String 주소, String 시도, String 우편번호, String 전화번호, String 주문일, String 납기일, int 인사번호, int 수량, String 제품이름, String  제품분류, int 단가, int 재고량) {
        this.제품번호 = 제품번호;
        this.주문번호 = 주문번호;
        this.고객번호 = 고객번호;
        this.고객이름 = 고객이름;
