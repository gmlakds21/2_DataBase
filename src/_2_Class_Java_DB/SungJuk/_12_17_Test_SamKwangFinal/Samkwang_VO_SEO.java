...
public class Samkwang_VO_SEO {
    
    private int 인사번호;
    private int 주문번호;
    private int 운송ID;
    private String 운송이름;
    private String 담당자_전화번호;
    private String 주문일;
    private String 납기일;
    private int 고객번호;
    ...
    public Samkwang_VO_SEO() {
    }

    public Samkwang_VO_SEO(int 인사번호, int 주문번호, int 운송ID, String 운송이름, String 주문일, String 직책) {
        this.인사번호 = 인사번호;
        this.주문번호 = 주문번호;
        this.운송ID = 운송ID;
        this.운송이름 = 운송이름;
    ...
    public Samkwang_VO_SEO(int 인사번호, int 주문번호, int 운송ID, String 운송이름, String 담당자_전화번호, String 주문일, String 납기일, int 고객번호, String 주민등록번호, String 성명, String 소속부서, String 직책, String 입사일) {
        this.인사번호 = 인사번호;
        this.주문번호 = 주문번호;
        this.운송ID = 운송ID;
        this.운송이름 = 운송이름;
        this.담당자_전화번호 = 담당자_전화번호;
        this.주문일 = 주문일;
        this.납기일 = 납기일;
        this.고객번호 = 고객번호;
        this.주민등록번호 = 주민등록번호;
    ...
    public String get담당자_전화번호() {
        return 담당자_전화번호;
    }

    public void set담당자_전화번호(String 담당자_전화번호) {
        this.담당자_전화번호 = 담당자_전화번호;
    }
